...
export default function Home() {
  return (
    <div className="w-[80%] min-h-full px-4 py-8 flex gap-5 flex-col  mt-16 ">
      ...
      <div className=" flex items-center gap-4 font-bold">
        <div className=" px-6 py-2 bg-primary flex gap-2 items-center rounded-md hover:bg-accent duration-200  ">
          <FaPlus  className='  text-white' size={20} /> <p className=' capitalize text-white '>give</p>
        </div>
        <p>or</p>
        <div className=" px-6 py-2 bg-secondary flex gap-2 items-center rounded-md hover:bg-primary duration-200">
